...
async function seedData() {
  ...
  try {
    ...
    const existingAdmin = db.user.findUnique({ where: { email: 'admin@florecer.com' } });
    ...
    const products = [
      {
        ...
        descripcion: 'Potente serum antioxidante con vitamina C para iluminar y proteger la piel',
        precio: 45.99,
        imagen_url: 'https://images.unsplash.com/photo-1556228453-efd6c1ff04f6?w=400&h=400&fit=crop',
        categoria: 'skincare'
      },
      {
        nombre: 'Crema Hidratante Facial',
        descripcion: 'Crema hidratante ligera con ácido hialurónico para todo tipo de piel',
        precio: 32.50,
        imagen_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop',
        categoria: 'skincare'
      },
      {
        ...
        precio: 28.75,
        imagen_url: 'https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?w=400&h=400&fit=crop',
        categoria: 'hair'
      },
      {
        nombre: 'Mascarilla Purificante',
        descripcion: 'Mascarilla de arcilla verde para purificar y desintoxicar la piel',
        precio: 18.99,
      ...
      },
      {
        ...
        precio: 24.00,
        imagen_url: 'https://images.unsplash.com/photo-1574017411378-f1ddc1b8d0f6?w=400&h=400&fit=crop',
        categoria: 'hair'
      },
      {
        ...
        precio: 38.50,
        imagen_url: 'https://images.unsplash.com/photo-1556229010-aa0134e2881a?w=400&h=400&fit=crop',
        categoria: 'skincare'
      }
    ];
